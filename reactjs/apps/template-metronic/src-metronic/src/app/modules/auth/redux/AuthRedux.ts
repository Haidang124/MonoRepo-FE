...
export const reducer = persistReducer(
  {storage, key: 'v1-ai-talk-auth', whitelist: ['user', 'accessToken']},
...
export const actions = {
  ...
  fulfillUser: (user: UserModel, permissions: string[]) => ({
...
export function* saga() {
  ...
  yield takeLatest(actionTypes.UserRequested, function* userRequested() {
    ...
    const {data: {user, permissions}} = yield getAppConfig()
    yield put(actions.fulfillUser(user, permissions))
  })
}
