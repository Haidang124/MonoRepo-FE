  ...
  return (
    <>
      <MenuInnerWithSub
        ...
        menuTrigger='click'
      >
        <MenuItem to='/admin/functions' title={intl.formatMessage({id: 'MENU.FUNCTIONS'})} hasBullet={true} />
        <MenuItem to='/admin/roles' title={intl.formatMessage({id: 'MENU.ROLES'})} hasBullet={true} />
      </MenuInnerWithSub>
